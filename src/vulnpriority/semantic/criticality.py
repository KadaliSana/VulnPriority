...
from vulnpriority.core.hashing import config_hash, sha256_text
from vulnpriority.core.interfaces import LLMBackend, SandboxedPrompt, Sanitizer
...
try:  # pragma: no cover - exercised only once vulnpriority.llm exists
    from vulnpriority.llm.schemas import AssetCriticalityOut  # type: ignore[no-redef]
