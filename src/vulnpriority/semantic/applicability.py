...
first, through :mod:`vulnpriority.semantic.cpe_match`. When that evidence comes from tier <= 1
...
from vulnpriority.core.enums import ApplicabilityVerdict, TrustTier, VersionMatch
from vulnpriority.core.interfaces import LLMBackend, Sanitizer
...
from vulnpriority.semantic.cpe_match import match_affected
...
try:  # pragma: no cover - exercised only once vulnpriority.llm exists
    from vulnpriority.llm.schemas import ApplicabilityOut  # type: ignore[no-redef]
