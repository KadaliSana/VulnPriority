...
:mod:`vulnpriority.synth.world`; this module only lays out the ground they sit on.
"""
...
from vulnpriority.core.enums import EndpointFunction, HttpMethod, PrivilegeLevel, Provenance
from vulnpriority.core.models import Endpoint, TechComponent, UntrustedText
from vulnpriority.ingest.normalize import make_endpoint_id
...
def generate_endpoints(
    ...
    *,
    ...
    ``config`` is a :class:`~vulnpriority.core.config.SyntheticConfig` (or anything exposing
