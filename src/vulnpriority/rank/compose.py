...
from vulnpriority.rank.explain import EvidenceExplainer
...
def rank_scan(
    ...
    :class:`vulnpriority.rank.explain.ShapExplainer`. It is optional because the baselines
    ...
    :class:`vulnpriority.rank.rank_guard.RankManipulationDetector`); they are merged with any
