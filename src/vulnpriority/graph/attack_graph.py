...
:mod:`vulnpriority.graph.privilege_map` whenever the CWE is covered, and only falls back to
...
from vulnpriority.core.enums import PrivilegeLevel, TrustTier
...
from vulnpriority.graph.privilege_map import is_known_cwe, privileges_for
