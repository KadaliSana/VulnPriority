...
(``vulnpriority.graph.attack_graph.edge_evidence_tier``): when the CWE is in this table the
...
def privileges_for(
    ...
    2. For an unknown or absent CWE, the assessment's own
       ...
       :func:`vulnpriority.graph.attack_graph.edge_evidence_tier` treats an edge built this
