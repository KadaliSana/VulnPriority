...
``python -m vulnpriority.web --demo --serve``
"""
...
from vulnpriority.core.money import format_money_compact
...
from vulnpriority.core.enums import DetectorName
...
def demo_dashboard() -> DashboardData:
    ...
    manifest = RunManifest(
        ...
        as_of=AS_OF, command="python -m vulnpriority.web --demo",
    )
