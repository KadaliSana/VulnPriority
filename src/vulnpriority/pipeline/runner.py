...
from vulnpriority.core.enums import FeedMode, LLMBackendKind, RankerName
from vulnpriority.core.errors import ConfigError
from vulnpriority.core.hashing import dataset_hash
from vulnpriority.core.models import ComponentFlags, RunManifest, Scan
from vulnpriority.ingest.normalize import DEFAULT_SCANNED_AT
from vulnpriority.pipeline import stages as stage_functions
from vulnpriority.pipeline.artifacts import (
    RunArtifacts,
    default_run_id,
    default_run_root,
)
from vulnpriority.pipeline.stages import StageUnavailableError
...
def _resolved_assessor(config: Any) -> tuple[LLMBackendKind, str, FeedMode]:
    ...
    try:
        from vulnpriority.core.resolve import resolve_run
    ...
    if backend == LLMBackendKind.GEMINI:
        from vulnpriority.llm.gemini_backend import resolve_model
