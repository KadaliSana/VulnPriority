...
Nothing in :mod:`vulnpriority.scan` decides for itself whether a request is permitted. The
...
from vulnpriority.scan.models import ProbeKind, ScanRequest
...
class RobotsPolicy:
    ...
    :class:`~vulnpriority.scan.models.ScanRequest` decides whether its rules bind.
