...
limits in :mod:`vulnpriority.scan.safety` become behaviour:
...
from vulnpriority.core.models import Frozen
from vulnpriority.ingest.normalize import canonical_url
from vulnpriority.scan.models import Page, ScanRequest
...
class HttpClient:
    ...
    def default_headers(self) -> dict[str, str]:
        ...
        validated on :class:`~vulnpriority.scan.models.ScanRequest` cannot be overridden by
...
def fetch_robots_policy(client: HttpClient, request: ScanRequest) -> RobotsPolicy:
    ...
    :attr:`~vulnpriority.scan.models.ScanRequest.respect_robots` is off - the default - the
