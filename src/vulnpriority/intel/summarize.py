...
* It is labelled. :class:`~vulnpriority.intel.models.IntelSummary` carries
...
from vulnpriority.intel.queries import normalize_url
from vulnpriority.llm.heuristic import strip_imperative_sentences
...
#: Deliberately the same shape as the one in :mod:`vulnpriority.llm.heuristic`, so "2.5.22"
