...
* **Offline by default.** A :class:`FixtureFeed` has no HTTP client at all and raises
  :class:`~vulnpriority.core.errors.OfflineViolationError` from any method that would fetch.
...
from vulnpriority.core.enums import FeedMode, TrustTier
from vulnpriority.core.errors import FeedUnavailableError, OfflineViolationError, TemporalLeakageError
from vulnpriority.core.interfaces import (
    EpssFeed,
    ExploitFeed,
    FeedClient,
    KevFeed,
...
from vulnpriority.core.models import EpssRecord, ExploitEvidence, KevRecord, ReferenceDoc, VulnIntel
...
class LiveFeedBase(FeedClient[Any]):
    ...
    user_agent: ClassVar[str] = "vulnpriority/0.1 (offline-by-default research framework)"
