...
:class:`~vulnpriority.core.interfaces.Sanitizer` protocol. ``build_sandboxed_prompt`` is the
...
from vulnpriority.core.enums import InjectionCategory, InjectionVerdict, Provenance, TrustTier, tier_of
from vulnpriority.core.hashing import config_hash
from vulnpriority.core.interfaces import SandboxedPrompt
from vulnpriority.core.models import InjectionSignal, SanitizationReport, UntrustedText
from vulnpriority.sandbox.canary import make_canary
from vulnpriority.sandbox.delimit import envelope, make_nonce
