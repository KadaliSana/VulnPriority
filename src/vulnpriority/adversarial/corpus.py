...
* every :class:`~vulnpriority.core.enums.InjectionCategory` represented at least once;
...
from vulnpriority.core.config import PROJECT_ROOT, AdversarialConfig
...
from vulnpriority.core.models import AdversarialCase
...
def load_corpus(
    ...
    *,
    ...
    frozen :class:`~vulnpriority.core.models.AdversarialCase` model, so a corpus that drifts from
