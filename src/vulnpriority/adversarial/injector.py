...
from vulnpriority.core.enums import ExploitMaturity, ExploitSource, Provenance
...
def inject(
    ...
    Raises :class:`~vulnpriority.core.errors.ConfigError` when the declared surface does not
