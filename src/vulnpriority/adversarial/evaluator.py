...
independent of ``vulnpriority.pipeline`` (which would be a cycle: the pipeline runs the
...
from vulnpriority.core.config import AdversarialConfig, SandboxConfig
from vulnpriority.core.enums import InjectionCategory, LLMBackendKind, tier_of
...
from vulnpriority.adversarial.corpus import attack_cases, benign_controls
...
from vulnpriority.adversarial.injector import InjectionSite, inject, plan_injection
from vulnpriority.sandbox.canary import find_canary_leaks
...
#: How each measured delta maps onto :class:`~vulnpriority.core.models.AdversarialExpectation`.
