...
:mod:`vulnpriority.decision.remediation_cost` and varies by the class of change the CWE
...
def cluster_items(items: Iterable[SelectionItem]) -> list[Cluster]:
    ...
    cluster are the same defect, and :mod:`vulnpriority.decision.remediation_cost` already
