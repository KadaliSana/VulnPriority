"""HTML rendering of an :class:`~vulnprio.report.model.AssessmentReport`.
...
def render_html(
    ...
    parts: list[str] = [
        ...
        '<meta name="generator" content="vulnprio assessment report">',
    ...
    stamp_bits = [
        ...
        f"vulnprio {report.meta.framework_version}",
    ]
    ...
    parts += [
        ...
        _inline(
            "Produced by vulnprio. Every figure in this document is either read from the run "
