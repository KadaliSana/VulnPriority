...
CAPABILITIES: tuple[Capability, ...] = (
    Capability(
        ...
        framework_modules=("src/vulnprio/decision/expected_loss.py", "src/vulnprio/decision/impact.py"),
    ...
    Capability(
        ...
        framework_position=CapabilityLevel.HAS,
        framework_modules=(
            "src/vulnprio/attacker/model.py",
            "src/vulnprio/attacker/likelihood.py",
            "src/vulnprio/attacker/presets.py",
        ),
    ...
    Capability(
        ...
        nature=CapabilityNature.SCIENTIFIC,
        framework_position=CapabilityLevel.HAS,
        framework_modules=("src/vulnprio/decision/impact.py",),
    ...
    Capability(
        ...
        framework_position=CapabilityLevel.HAS,
        framework_modules=(
            "src/vulnprio/feeds/epss.py",
            "src/vulnprio/feeds/kev.py",
            "src/vulnprio/feeds/exploitdb.py",
            "src/vulnprio/feeds/bundle.py",
        ),
    ...
    Capability(
        ...
        nature=CapabilityNature.METHODOLOGICAL,
        framework_position=CapabilityLevel.HAS,
        framework_modules=("src/vulnprio/semantic/criticality.py", "src/vulnprio/semantic/lexicon.py"),
    ...
    Capability(
        ...
        framework_position=CapabilityLevel.HAS,
        framework_modules=(
            "src/vulnprio/ingest/zap.py",
            "src/vulnprio/ingest/burp.py",
            "src/vulnprio/ingest/nuclei.py",
            "src/vulnprio/ingest/normalize.py",
            "src/vulnprio/ingest/correlate.py",
        ),
        framework_tests=(
    ...
    Capability(
        ...
        framework_position=CapabilityLevel.HAS,
        framework_modules=(
            "src/vulnprio/semantic/applicability.py",
            "src/vulnprio/semantic/cpe_match.py",
            "src/vulnprio/ingest/tech_fingerprint.py",
        ),
    ...
    Capability(
        ...
        framework_position=CapabilityLevel.HAS,
        framework_modules=(
            "src/vulnprio/graph/attack_graph.py",
            "src/vulnprio/graph/reachability.py",
            "src/vulnprio/graph/chain_scorer.py",
        ),
    ...
    Capability(
        ...
        nature=CapabilityNature.SCIENTIFIC,
        framework_position=CapabilityLevel.HAS,
        framework_modules=("src/vulnprio/graph/monotone.py", "src/vulnprio/graph/reachability.py"),
    ...
    Capability(
        ...
        framework_position=CapabilityLevel.HAS,
        framework_modules=(
            "src/vulnprio/rank/features.py",
            "src/vulnprio/rank/lambdamart.py",
            "src/vulnprio/rank/compose.py",
        ),
    ...
    Capability(
        ...
        nature=CapabilityNature.METHODOLOGICAL,
        framework_position=CapabilityLevel.HAS,
        framework_modules=("src/vulnprio/rank/explain.py",),
    ...
    Capability(
        ...
        nature=CapabilityNature.METHODOLOGICAL,
        framework_position=CapabilityLevel.PARTIAL,
        framework_modules=("src/vulnprio/eval/labels.py", "src/vulnprio/synth/oracle.py"),
    ...
    Capability(
        ...
        nature=CapabilityNature.METHODOLOGICAL,
        framework_position=CapabilityLevel.HAS,
        framework_modules=("src/vulnprio/eval/splits.py", "src/vulnprio/feeds/base.py"),
    ...
    Capability(
        ...
        nature=CapabilityNature.METHODOLOGICAL,
        framework_position=CapabilityLevel.HAS,
        framework_modules=("src/vulnprio/eval/ablation.py", "src/vulnprio/rank/features.py"),
    ...
    Capability(
        ...
        framework_position=CapabilityLevel.HAS,
        framework_modules=(
            "src/vulnprio/rank/likelihood_head.py",
            "src/vulnprio/eval/minority.py",
            "src/vulnprio/eval/metrics.py",
        ),
    ...
    Capability(
        ...
        nature=CapabilityNature.SCIENTIFIC,
        framework_position=CapabilityLevel.HAS,
        framework_modules=("src/vulnprio/rank/likelihood_head.py", "src/vulnprio/eval/calibration.py"),
    ...
    Capability(
        ...
        nature=CapabilityNature.METHODOLOGICAL,
        framework_position=CapabilityLevel.HAS,
        framework_modules=("src/vulnprio/select/knapsack.py", "src/vulnprio/decision/remediation_cost.py"),
    ...
    Capability(
        ...
        nature=CapabilityNature.METHODOLOGICAL,
        framework_position=CapabilityLevel.PARTIAL,
        framework_modules=("src/vulnprio/eval/simulation.py", "src/vulnprio/synth/oracle.py"),
    ...
    Capability(
        ...
        framework_position=CapabilityLevel.HAS,
        framework_modules=(
            "src/vulnprio/adversarial/evaluator.py",
            "src/vulnprio/adversarial/corpus.py",
            "src/vulnprio/rank/rank_guard.py",
        ),
        framework_tests=(
    ...
    Capability(
        ...
        framework_position=CapabilityLevel.HAS,
        framework_modules=(
            "src/vulnprio/sandbox/pipeline.py",
            "src/vulnprio/sandbox/instruction_filter.py",
            "src/vulnprio/enrich/trust.py",
            "src/vulnprio/llm/guarded.py",
        ),
        framework_tests=(
    ...
    Capability(
        ...
        nature=CapabilityNature.ENGINEERING,
        framework_position=CapabilityLevel.HAS,
        framework_modules=("src/vulnprio/pipeline/runner.py", "src/vulnprio/pipeline/artifacts.py"),
    ...
    Capability(
        ...
        framework_position=CapabilityLevel.HAS,
        framework_modules=(
            "src/vulnprio/llm/heuristic.py",
            "src/vulnprio/feeds/base.py",
            "src/vulnprio/synth/generator.py",
        ),
        framework_tests=(
