...
structural defect here is a hard :class:`~vulnprio.core.errors.ConfigError` at load time
...
* every capability vector covers **every** dimension in
  :data:`~vulnprio.novelty.capabilities.CAPABILITY_KEYS` exactly - no missing dimension
...
from vulnprio.novelty.capabilities import CAPABILITY_KEYS, CapabilityLevel
...
def load_corpus(path: Path | None = None) -> Corpus:
    ...
    Raises :class:`~vulnprio.core.errors.ConfigError` on any structural defect.
    """
