...
``scans/<scan_id>.json``
    Canonical :class:`~vulnprio.core.models.Scan` documents - the same format
    :class:`~vulnprio.ingest.generic.GenericJsonParser` reads, so the pipeline ingests
...
from vulnprio.core.config import PROJECT_ROOT, PipelineConfig, SyntheticConfig
...
from vulnprio.core.hashing import dataset_hash, stable_id
...
from vulnprio.ingest.normalize import make_finding_id, make_scan_id
from vulnprio.synth.feeds import write_feed_fixtures
from vulnprio.synth.oracle import ExploitationOracle, LatentFinding, simulate_exploitation
from vulnprio.synth.pages import generate_reference_pages
...
from vulnprio.synth.world import VULN_TEMPLATES, LatentWorld, build_world, clamp01
