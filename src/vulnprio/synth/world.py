...
:mod:`vulnprio.synth.oracle` reads the latents; the framework reads the evidence. Neither
...
def _reference_urls(cve_id: str, vuln_topic: str, rng: Random, *, kev: bool,
    ...
    if rng.random() < 0.65:
        urls.append(f"https://github.com/vulnprio-synthetic/advisories/blob/main/{cve_id}.md")
    if rng.random() < 0.45:
