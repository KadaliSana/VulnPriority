...
:class:`~vulnprio.llm.guarded.GuardedBackend`. Wrapping here rather than at the call site
...
from vulnprio.core.config import LLMConfig, PipelineConfig
from vulnprio.core.enums import LLMBackendKind
from vulnprio.core.errors import ConfigError
from vulnprio.core.interfaces import LLMBackend
from vulnprio.core.resolve import concrete_llm
from vulnprio.llm.anthropic_backend import AnthropicBackend
from vulnprio.llm.cache import LLMResponseCache
from vulnprio.llm.gemini_backend import GeminiBackend
from vulnprio.llm.guarded import GuardedBackend
from vulnprio.llm.heuristic import HeuristicBackend
from vulnprio.llm.openai_compatible import OpenAICompatibleBackend
...
def build_llm_backend(
    ...
    ``sandbox`` is optional: when a :class:`~vulnprio.sandbox.pipeline.Sandbox` is passed
    ...
    :class:`~vulnprio.core.enums.LLMBackendKind`, present and future. That is the point of
