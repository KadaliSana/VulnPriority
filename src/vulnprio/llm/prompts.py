...
#: :mod:`vulnprio.llm.heuristic` (which scores from them offline). Missing keys are
...
def prompt_hash(task: str) -> str:
    ...
    Recorded in :class:`~vulnprio.core.models.LLMAudit` so a stored assessment can be
