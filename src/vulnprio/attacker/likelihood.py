...
``vulnprio.attacker.model.p_exploit`` weights.
...
ordinal; :func:`vulnprio.attacker.model.p_exploit` applies the attacker-relative part.
...
def build_evidence(
    ...
    :func:`vulnprio.attacker.model.p_exploit` always uses its own attacker.
    """
