...
class UntrustedText(Frozen):
    ...
    Never rendered into a prompt except through ``vulnprio.sandbox.pipeline.Sandbox``.
...
# ---------------------------------------------------------------------------
# Internet exploit intelligence (Component A; produced by vulnprio.intel)
# ---------------------------------------------------------------------------
#
...
# here rather than in ``vulnprio.intel`` for the same reason every other inter-package
...
# below imports ``vulnprio.intel``, ``anthropic`` or ``httpx``; core stays dependency-light.
