...
by :class:`~vulnprio.feeds.bundle.DefaultIntelAssembler`.
"""
...
from vulnprio.core.enums import CvssVersion, Provenance, ScoreSource
from vulnprio.core.interfaces import NvdFeed
from vulnprio.core.models import AffectedProduct, CvssRecord, ReferenceDoc, UntrustedText, VulnIntel
from vulnprio.feeds.base import FixtureFeed, LiveFeedBase, as_of_guard, parse_feed_date
from vulnprio.feeds.cvss_policy import parse_cvss_vector
