...
* **How much does this asset matter?** (:mod:`~vulnprio.semantic.criticality`, Goal 1) --
...
* **How exploitable is this finding?** (:mod:`~vulnprio.semantic.exploitability`, Goal 2)
...
* **Does it apply here at all?** (:mod:`~vulnprio.semantic.applicability`, Goal 3) --
  decided by :mod:`~vulnprio.semantic.cpe_match` first; a tier <= 1 version mismatch is
  authoritative and no model output can overturn it.

:class:`~vulnprio.semantic.assessor.AgenticSemanticAssessor` wires all three together.
"""

from __future__ import annotations

from vulnprio.semantic.applicability import assess_applicability, baseline_applicability
from vulnprio.semantic.assessor import AgenticSemanticAssessor, AssessorStats
...
from vulnprio.semantic.exploitability import (
