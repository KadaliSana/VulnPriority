...
advisory links and :mod:`vulnprio.feeds.references` already fetches them; a search that
...
:mod:`vulnprio.llm.prompts` keeps its own: they are the only place instructions may come
...
from vulnprio.core.models import Finding, TechComponent, VulnIntel
